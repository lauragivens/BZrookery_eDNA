...
ps <- readRDS(paste0(dir_results,"/ps.v2.nt.rds"))
ps.troph <- readRDS(paste0(dir_results,"/ps.v2.nt.troph.rds"))

taxa <- readRDS(paste0(dir_results,"/taxtable.v2.nt.rds"))
taxa_troph <- readRDS(paste0(dir_results,"/taxtable.v2.nt.wtroph.rds"))
...
# Session Info   
```{r}
saveRDS(decontam.ps.troph,paste0(dir_results,"/decontam.v2.ps.nt.troph.rds"))

saveRDS(prune_c.ps,paste0(dir_results,"/prune.decontam.v2.ps.nt.troph.keepblanks.rds"))
saveRDS(prune.decontam.ps.troph,paste0(dir_results,"/prune.decontam.v2.ps.nt.troph.rds"))
...
```{r}
save.image('/Users/lauragivens/Desktop/R/BZrookery_eDNA/Rdata/07_ntBlanks_v2.RData')
```
