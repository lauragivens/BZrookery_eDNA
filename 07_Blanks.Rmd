...
# Removal  
So now that we've looked at that, we're going to use a combination of both methods to remove contaminant ASVs from the ps object  
...
# Session Info   
```{r}
saveRDS(prune.ps.troph,paste0(dir_results,"/prune.ps.troph.rds"))
```
