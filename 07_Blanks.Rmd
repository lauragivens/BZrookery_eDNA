...
ps <- readRDS(paste0(dir_results,"/ps.v2.rds"))
ps.troph <- readRDS(paste0(dir_results,"/ps.v2.troph.rds"))

taxa <- readRDS(paste0(dir_results,"/taxtable.v2.rds"))
taxa_troph <- readRDS(paste0(dir_results,"/taxtable.v2.wtroph.rds"))
...
# Session Info   
```{r}
saveRDS(decontam.ps.troph,paste0(dir_results,"/decontam.v2.ps.troph.rds"))

saveRDS(prune_c.ps,paste0(dir_results,"/prune.decontam.v2.ps.troph.keepblanks.rds"))
saveRDS(prune.decontam.ps.troph,paste0(dir_results,"/prune.decontam.v2.ps.troph.rds"))
```
