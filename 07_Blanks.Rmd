...
saveRDS(prune_c.ps,paste0(dir_results,"/prune.decontam.ps.troph.keepblanks.rds"))
saveRDS(prune.decontam.ps.troph,paste0(dir_results,"/prune.decontam.ps.troph.rds"))
```
