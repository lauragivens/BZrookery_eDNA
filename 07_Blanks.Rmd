...
ps <- readRDS(paste0(dir_results,"/ps.troph.combined.rds"))

taxa <- readRDS(paste0(dir_results,"/tax.troph.combined.df.rds"))
...
# Session Info   
```{r}
saveRDS(decontam.ps,paste0(dir_results,"/decontam.combined.ps.rds"))

saveRDS(prune_c.ps,paste0(dir_results,"/prune.decontam.combined.ps.keepblanks.rds"))
saveRDS(prune.decontam.ps,paste0(dir_results,"/prune.decontam.combined.ps.rds"))
```

```{r}
save.image(paste0(dir_data,'/07_Blanks_combined.RData'))
```
